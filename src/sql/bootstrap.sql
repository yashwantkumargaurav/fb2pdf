...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (1, 'Sony Reader PRS-500,505,600,700', 'Sony Reader (portrait). Includes: PRS-500,505,600,700', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (2, 'Sony Reader PRS-500,505,600,700 (landscape)', 'Sony Reader (landscape). Includes: PRS-500,505,600,700', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (3, 'ECTACO JetBook', 'ECTACO JetBook (portrait)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (4, 'ECTACO JetBook (landscape)', 'ECTACO JetBook (landscape)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (5, 'iPhone', 'Apple iPhone (portrait). Includes: iPhone, iPhone3G', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (6, 'iPhone (landscape)', 'Apple iPhone (landscape). Includes: iPhone, iPhone3G', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (7, 'Kindle DX', 'Amazon Kindle DX (portrate)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (8, 'Kindle DX (landscape)', 'Amazon Kindle DX (landscape)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (9, 'Kindle 2', 'Amazon Kindle 2 (portrait)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (10, 'Kindle 2 (landscape)', 'Amazon Kindle 2 (landscape)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (11, 'iPad', 'Apple iPad (portrait)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (12, 'iPad (landscape)', 'Apple iPad (landscape)', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (13, 'Sony Reader PRS-300', 'Sony Reader (portrait). Includes: PRS-300', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (14,  'Sony Reader PRS-300 (landscape)', 'Sony Reader (landscape). Includes: PRS-300', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (15, 'Sony Reader PRS-900', 'Sony Reader (portrait). Includes: PRS-900', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (16,  'Sony Reader PRS-900 (landscape)', 'Sony Reader (landscape). Includes: PRS-900', 'pdf', 'zip');
...
INSERT INTO Formats (id, title, description, filetype, compress) 
       VALUES (17,  'EPUB', 'Open e-book standard by the International Digital Publishing Forum', 'epub', 'none');
