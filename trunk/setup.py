...
setup(name='fb2pdf',
      ...
      data_files=[('share/texmf-local/', ['src/TeX/verse.sty', 'src/TeX/epigraph.sty','src/TeX/sectsty.dtx', 'src/TeX/sectsty.ins']),('share/fb2pdf',['etc/broken-image.png']),('share/java',['lib/epubgen-0.5.0.jar'])]
     )
